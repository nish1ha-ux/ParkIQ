...
class ParkIQAIInferenceEngine:
    """
    Decoupled Production AI Inference Engine for ParkIQ:
    ...
    def load_models(self):
        try:
            ...
            if not os.path.exists(dep_path):
                print("[AI Inference Engine] Models not found. Triggering training pipeline...")
            ...
            print("[AI Inference Engine] All models loaded successfully.")
    ...
    def predict_departure_duration(self, entry_time: datetime, vehicle_type: str = "SEDAN", floor_level: int = 1) -> Dict[str, Any]:
        ...
        return {
            ...
            "model_used": "GradientBoostingRegressor_Departure_v1" if self.model_dep else "RuleBasedFallback"
        }
    ...
    def forecast_occupancy_and_congestion(self, current_occupancy_pct: float, offset_hours: int = 2) -> Dict[str, Any]:
        ...
        return {
            ...
            "model_used": "GradientBoostingRegressor_Occupancy_v1" if self.model_occ else "RuleBasedFallback"
        }
    ...
    def detect_qr_cloning_fraud(self, time_delta_sec: float, distance_km: float) -> Dict[str, Any]:
        ...
        Detects QR code cloning or impossible travel velocity using Random Forest Classifier.
        """
        ...
        return {
            ...
            "model_used": "RandomForestClassifier_Fraud_v1" if self.model_fraud else "RuleBasedFallback"
        }
